...
auth_token = "6e1e56a04352127d6973387bc820889f"
loop = 0
...
def main():
    ...
    if messages.from_ != twiilio_number:
        ...
        print(str(loop) + " " + messages.from_ + " " + messages.to + " " + messages.body + " " + str(messages.date_sent))
        ...
        if get_date_of_birth():
            if (len(messages.body) == 8) and messages.body.isdigit():
                ...
                if valid_date_of_birth(mm,dd,yyyy):
                    ...
                    message = client.messages \
                        .create(
                            body='This is your 15% discount code: '+ str(number) + '\nValid from: 05/21/2022 - 06/04/2022',
                            from_='+15795000888',
                            to=customer_phone_number
                        )
        ...
        if get_date_of_birth_fr():
            if (len(messages.body) == 8) and messages.body.isdigit():
                ...
                if valid_date_of_birth_fr(mm,dd,yyyy):
                    ...
                    message = client.messages \
                        .create(
                            body='Ceci est votre code de réduction de 15 %: '+ str(number) + '\nValable du: 05/21/2022 - 06/04/2022',
                            from_='+15795000888',
                            to=customer_phone_number
                        )
